package com.hy.springbootdemo.component.exception;

import com.hy.springbootdemo.common.ResponseBean;
...
public class CustomExceptionAdvice {
    ...
    private Logger logger = LoggerFactory.getLogger(CustomExceptionAdvice.class);
    ...
    public ResponseBean globalException(HttpServletRequest request, Throwable ex) {
        String commonErrorMsg = "server error!";
        return new ResponseBean(this.getStatus(request).value(), commonErrorMsg +">>>"+ex.toString() + ": " + ex.getMessage(), null);
    }
